...
export const INITIAL_COLLECTIBLES: readonly {
  ...
  { perk: CollectiblePerk.CASH_TIERED, name: "Cash Tier 1", strength: 1, tycPrice: "0.5", usdcPrice: "0.10", icon: <Gem className="w-8 h-8" /> },
  ...
  { perk: CollectiblePerk.TAX_REFUND, name: "Tax Refund Tier 1", strength: 1, tycPrice: "0.6", usdcPrice: "0.10", icon: <Gem className="w-8 h-8" /> },
