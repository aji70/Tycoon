...
export function LoadoutCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative bg-gradient-to-br ${bgGradient} rounded-2xl p-6 border ${borderColor} backdrop-blur-sm transition-all duration-300 group-hover:border-${isDanger ? "red" : "cyan"}-400/60 h-full`}
      >
        {/* Metallic accent bar */}
        <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${isDanger ? "from-red-500 to-orange-500" : "from-cyan-500 to-cyan-400"} rounded-t-2xl opacity-60`} />
