          ...
          >
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="min-w-0">
                <div className="text-sm font-orbitron font-bold text-white uppercase tracking-wide">
                  {rule.label}
                </div>
                <div className="text-xs text-cyan-300/60 font-dmSans">
                  {rule.desc}
                </div>
              </div>
            </div>
            ...
            <motion.button
              ...
              className={`relative w-14 h-7 rounded-full transition-all duration-300 flex-shrink-0 border-2 ${
                isActive
            ...
            >
              ...
              <motion.div
                ...
                className={`absolute top-0.5 w-6 h-6 rounded-full transition-colors ${
