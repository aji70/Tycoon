...
export default function PlayWithAI3DMobile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950/30 flex flex-col pt-[70px]">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-10">
        <div className="max-w-md mx-auto space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gradient-to-br from-cyan-900/40 to-blue-900/40 rounded-xl p-4 border border-amber-500/30">
              <div className="flex items-center gap-2 mb-2">
                <FaUser className="w-4 h-4 text-amber-400" />
                <h3 className="text-sm font-bold text-amber-300">Your Piece</h3>
              </div>
              <Select value={settings.symbol} onValueChange={(v) => setSettings((p) => ({ ...p, symbol: v }))}>
                <SelectTrigger className="h-10 bg-slate-800/80 border-amber-500/40 text-white text-sm">
            ...
            <div className="bg-gradient-to-br from-purple-900/40 to-pink-900/40 rounded-xl p-4 border border-amber-500/30">
              <div className="flex items-center gap-2 mb-2">
                <FaRobot className="w-4 h-4 text-amber-400" />
                <h3 className="text-sm font-bold text-amber-300">AI Opponents</h3>
              </div>
              <Select
              ...
              {registrySupported && registeredAgents.length > 0 && (
                <p className="mt-1.5 text-[10px] text-amber-300/80 flex items-center gap-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-gradient-to-br from-indigo-900/40 to-purple-900/40 rounded-xl p-4 border border-amber-500/30">
              <div className="flex items-center gap-2 mb-2">
                <FaBrain className="w-4 h-4 text-amber-400" />
                <h3 className="text-sm font-bold text-amber-300">Duration</h3>
              </div>
              <Select
          ...
          <div className="bg-gradient-to-br from-red-900/40 to-orange-900/40 rounded-xl p-4 border border-amber-500/30">
            <div className="flex items-center gap-2 mb-2">
              <FaBrain className="w-4 h-4 text-amber-400" />
              <h3 className="text-sm font-bold text-amber-300">AI Difficulty</h3>
            </div>
            <Select
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="boss" className="text-amber-400 font-bold">BOSS</SelectItem>
              </SelectContent>
            </Select>
          </div>

          {registrySupported && registeredAgents.length > 0 && !agentsLoading && (
            <div className="bg-gradient-to-br from-emerald-900/40 to-teal-900/40 rounded-xl p-4 border border-amber-500/30">
              <div className="flex items-center gap-2 mb-2">
                <ShieldCheck className="w-4 h-4 text-amber-400" />
                <h3 className="text-sm font-bold text-amber-300">Verified AI</h3>
              </div>
              <ul className="space-y-1 max-h-20 overflow-y-auto">
                {registeredAgents.map((a) => (
                  <li key={a.tokenId} className="text-xs text-slate-300 flex justify-between items-center gap-2">
                    ...
                    <span className="text-amber-400/90 shrink-0 text-[10px]">{a.playStyle}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="bg-slate-800/60 rounded-xl p-4 border border-amber-500/30">
            <h3 className="text-base font-bold text-amber-400 mb-3 text-center">House Rules</h3>
